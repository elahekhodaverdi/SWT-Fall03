...
public class GUITest {
  ...
  public void testGUI() throws Exception {
    ...
    driver.findElement(By.cssSelector("#operations-restaurant-controller-getRestaurants > div.opblock-summary.opblock-summary-get > button.opblock-summary-control > svg.arrow")).click();
    ...
    driver.findElement(By.cssSelector("#operations-reservation-controller-getAvailableTimes > div.opblock-summary.opblock-summary-get > button.opblock-summary-control > svg.arrow")).click();
    ...
    driver.findElement(By.xpath("//input[@value='']")).click();
    driver.findElement(By.xpath("//input[@value='']")).clear();
    driver.findElement(By.xpath("//input[@value='']")).sendKeys("2");
    driver.findElement(By.xpath("//input[@value='']")).click();
    driver.findElement(By.xpath("//input[@value='']")).clear();
    driver.findElement(By.xpath("//input[@value='']")).sendKeys("2025-10-26");
    ...
    driver.findElement(By.xpath("//input[@value='']")).click();
    driver.findElement(By.xpath("//input[@value='']")).clear();
    driver.findElement(By.xpath("//input[@value='']")).sendKeys("4");
    ...
    driver.findElement(By.cssSelector("#operations-reservation-controller-cancelReservation > div.opblock-summary.opblock-summary-post > button.opblock-summary-control > svg.arrow")).click();
